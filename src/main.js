...
router.beforeEach((to, from, next) => {
  let name = to.name
  let allArr = ['depencestart', 'votebegin', 'votedetail', 'enrollstart', 'livestart', 'newstart', 'drawlist', 'depencelist', 'VoteRank', 'lotteryDial']
...
router.afterEach((route, from) => {
  ...
  let isFirst = false
  let allArr = ['depencestart', 'votebegin', 'votedetail', 'enrollstart', 'livestart', 'newstart', 'drawlist', 'lotteryDial']
  if (allArr.includes(name) && !from.name) {
    isFirst = true
  }
