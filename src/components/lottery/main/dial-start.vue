<template>
  <div class="dial-start-wrap">
    ...
    <div class="dial-container">
      <div class="container-title-on" v-if="isWheelShow">幸运大转盘</div>
      <div class="container-title" v-else>厚建软件党史答题幸运 大转盘</div>
      <div class="container-title-notice" v-if='isWheelShow'>
