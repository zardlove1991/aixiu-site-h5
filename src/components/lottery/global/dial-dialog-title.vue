...
//   position: relative;
  .dialog-header{
    width: px2rem(600px);
    height: px2rem(76px);
    @include img-retina("~@/assets/lottery/activityRule/propup2.png",
    "~@/assets/lottery/activityRule/propup2@2x.png", 100%, 100%);
    ...
    .left-point{
        ...
        "~@/assets/lottery/activityRule/point@2x.png", 100%, 100%);
        background-repeat: no-repeat;
        width: px2rem(44px);
        height: px2rem(44px);
        opacity: 0.5;
