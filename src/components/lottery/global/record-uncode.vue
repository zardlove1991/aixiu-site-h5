    ...
    <div class='record-unCode-dialog' v-if="show" v-fixed>
        <div class="record-unCode">
            ...
            <div class="record-unCode-header">
                ...
                <div class="record-unCode-header-right" @click.stop="onClose">
                    <i class="i-close"></i>
                </div>
            </div>
            <div class="container">
            ...
            <div class="record-unCode-footer"></div>
        </div>
