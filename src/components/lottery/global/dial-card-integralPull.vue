<template>
<div class="card-integralPull" v-if="show">
...
// 父组件样式
.card-integralPull .dialog /deep/.dialog-wrap{
  height: px2rem(664px);
}
.card-integralPull .dialog /deep/.dialog-wrap /deep/.dialog-pre{
  height: px2rem(394px) ;
}
.card-integralPull .dialog /deep/.dialog-wrap /deep/.divider{
    top:px2rem(462px)
}
.card-integralPull .dialog /deep/.dialog-wrap /deep/.dialog-next{
  height: px2rem(161px) ;
}
// 本身样式
.record-info-title{
