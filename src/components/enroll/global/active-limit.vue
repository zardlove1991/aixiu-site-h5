<template>
  ...
  <tips-dialog
    :show="show"
    @close="close()">
    <div class="active-limit-wrap" slot="tips-content">
...
<script>
import TipsDialog from '@/components/enroll/global/tips-dialog'
...
<style lang="scss">
  ...
  .active-limit-wrap  {
    ...
    .active-img {
      ...
      width: px2rem(334px);
      height: px2rem(244px);
      @include img-retina("~@/assets/enroll/tips-icon@2x.png","~@/assets/enroll/tips-icon@3x.png", 100%, 100%);
    }
    .dialog-ok-btn {
      width: px2rem(270px);
      height: px2rem(70px);
