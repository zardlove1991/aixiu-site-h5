<template>
  <div class="active-stop-dialog-wrap"
    v-if="show"
    :class="{'lock': isLock}">
    <!--弹窗模块-->
  ...
  .active-stop-dialog-wrap {
    ...
    .active-stop-content {
      ...
      .img-bg {
        width: px2rem(575px);
        height: px2rem(310px);
        @include img-retina('~@/assets/enroll/active-stop@2x.png', '~@/assets/enroll/active-stop@3x.png', px2rem(575px), px2rem(310px));
