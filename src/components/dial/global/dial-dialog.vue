<template>
  <div class="dialog" v-if="show">
      <div class="dialog-header">
          ...
          <div slot="left" class="close" @click="close"></div>
      </div>
...
//   position: relative;
  .dialog-header{
    width: px2rem(600px);
    height: px2rem(76px);
    @include img-retina("~@/assets/dial/activityRule/propup2.png",
    ...
    .title{
        ...
        margin-left: auto;
        margin-right: auto;
        @include img-retina("~@/assets/dial/activityRule/title.png",
        "~@/assets/dial/activityRule/title@2x.png", 100%, 100%);
        background-repeat: no-repeat;
        display: flex;
        // align-items: center;
        justify-content: center;
