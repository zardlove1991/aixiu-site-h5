...
<script>
import Model from '@/components/dial/global/dial-model-img'
...
.coupon  .model /deep/.model-wrap{
    height: px2rem(858px);
}
.coupon .model /deep/.model-bg{
    top:-18%;
}
.coupon .model /deep/.header-bg{
 top:-13.5%;
}
// 本身样式
.container{
    ...
    .prize-box{
        ...
        .prize-content{
            ...
            .coupon-bg{
                ...
                @include img-retina("~@/assets/dial/coupon/coupon-bg.png",
                "~@/assets/dial/coupon/coupon-bg@2x.png", 100%,100%);
                background-repeat: no-repeat;
                display: flex;
        ...
        .prize{
            ...
            .prize-bg{
                ...
                height: px2rem(38px);
                opacity: 1;
                @include img-retina("~@/assets/dial/prizeRecord/prize-bg.png",
                "~@/assets/dial/prizeRecord/prize-bg@2x.png",'~@/assets/dial/prizeRecord/prize-bg@3x.png' 100%, 100%);
                background-repeat: no-repeat;
                z-index: 10;
                display: flex;
                // align-items: center;
            ...
            .left-icon{
                ...
                height: px2rem(24px);
                opacity: 1;
                @include img-retina("~@/assets/dial/prizeRecord/left-icon 18.png",
                "~@/assets/dial/prizeRecord/left-icon 18@2x.png",'~@/assets/dial/prizeRecord/left-icon 18@3x.png' 100%, 100%);
                background-repeat: no-repeat;
                z-index: 2;
            }
            .right-icon{
                ...
                height: px2rem(24px);
                opacity: 1;
                @include img-retina("~@/assets/dial/prizeRecord/right-icon 18_1.png",
                "~@/assets/dial/prizeRecord/right-icon 18_1@2x.png",'~@/assets/dial/prizeRecord/right-icon 18_1@3x.png' 100%, 100%);
                background-repeat: no-repeat;
                z-index: 2;
            }
            .prize-name{
    ...
    .point{
        ...
        height: px2rem(114px);
        opacity: 0.2;
         @include img-retina("~@/assets/dial/recordDraw/point_1.png",
        "~@/assets/dial/recordDraw/point_1@2x.png", 100%,100%);
        background-repeat: no-repeat;
