...
.dialog {
  ...
  .dialog-wrap{
    ...
    .activity-title{
        ...
        position: absolute;
        top:px2rem(78px); left:px2rem(97px);
    }
    .activity-tip{
        width: px2rem(84px);
        height: px2rem(28px);
        ...
        position: absolute;
        top:px2rem(149px); left:px2rem(253px);
    }
    .count-down{
        position: absolute;
        top: px2rem(207px);
    ...
    .activity-img{
        ...
        width: px2rem(390px);
        height: px2rem(253px);
        @include img-retina("~@/assets/dial/activity/start_6.png",
        "~@/assets/dial/activity/start_6@2x.png", 100%, 100%);
        background-repeat: no-repeat;
    }
    .left-bottom-wrap{
        position: absolute;
