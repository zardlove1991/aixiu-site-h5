...
.model {
  ...
  .model-header{
    ...
    .close{
        ...
        height: px2rem(20px);
        // opacity: 0.4;
        @include img-retina("~@/assets/dial/close_1.png",
        "~@/assets/dial/close_1@2x.png", 100%, 100%);
    ...
    .left-point{
        ...
        "~@/assets/dial/activityRule/point@2x.png",'~@/assets/dial/activityRule/point@3x.png' 100%, 100%);
        background-repeat: no-repeat;
        position: absolute;
  ...
  .model-bg{
    ...
    left: px2rem(84px);top:-15%;
     @include img-retina("~@/assets/dial/modelImg/model-bg.png",
    "~@/assets/dial/modelImg/model-bg@2x.png", 100%, 100%);
    background-repeat: no-repeat;
    z-index: 10;
  }
  .header-bg{
    ...
    height: px2rem(202px);
    opacity: 1;
     @include img-retina("~@/assets/dial/modelImg/model-header 4.png",
    "~@/assets/dial/modelImg/model-header 4@2x.png", 100%, 100%);
    background-repeat: no-repeat;
  ...
  .model-footer{
    ...
    right: -6%;
    bottom:-4%;
    @include img-retina("~@/assets/dial/modelImg/model-footer 2.png",
    "~@/assets/dial/modelImg/model-footer 2@2x.png", 100%, 100%);
    background-repeat: no-repeat;
