...
.record-prize {
  ...
  .record-prize-header-bg {
    ...
    opacity: 1;
    @include img-retina(
      "~@/assets/dial/diallist/header-bg.png",
      "~@/assets/dial/diallist/header-bg@2x.png",
      100%,
      100%
    );
  ...
  .back {
    ...
    .arrow-left {
      ...
      @include img-retina(
        "~@/assets/dial/diallist/arrow-left.png",
        "~@/assets/dial/diallist/arrow-left@2x.png",
        100%,
        100%
      );
      color: #fff;
  ...
  .record-prize-content {
    ...
    .container {
      ...
      .bg {
        ...
        @include img-retina(
          "~@/assets/dial/unRecord/bg_2.png",
          "~@/assets/dial/unRecord/bg_2@2x.png",
          100%,
          100%
        );
  ...
  .logo {
    ...
    left: px2rem(205px);
    @include img-retina(
      "~@/assets/dial/diallist/bg.png",
      "~@/assets/dial/diallist/bg@2x.png",
      100%,
      100%
    );
    background-position-x: right;
