<template>
<div class='prize-verification-dialog'  v-if="show">
    <div class="prize-verification-header-bg">
        <div class="title">中奖啦</div>
        <div class="close-wrap" @click.stop="onClose">
            <i class="close"></i>
        </div>
    </div>
    <div class="prize-verification">
        <div class="container">
            ...
            <!-- <van-button  block  class="btns"  @click="onCancelCode">中奖二维码</van-button> -->
            <van-button  block  class="btns" v-if="prizeData.cancel_code" @click="onCancelCode">中奖二维码</van-button>
