<template>
<div class='card-packetPull-dialog' v-if="show" v-fixed>
  <div class="card-packetPull-border">
    <div class="card-packetPull">
      <div class="card-packetPull-header">
        <div class="title-bg">
      ...
      <div class="container">
        <!-- <div class="award-name">获得 四等奖微信红包</div> -->
        <div class="award-name">获得 {{itemData.prize_info.award_name}}微信红包</div>
        <div class="card-packetPull-wrap">
          <!-- <div class="packet-name">100<span>元</span></div> -->
          <div class="packet-name">{{packet.money}}<span>元</span></div>
        </div>
        <div class="tip">现金红包需在24小时内前往公众号领取，超 时自动过期</div>
  ...
  .card-packetPull-border{
    ...
    .card-packetPull{
        ...
        .container{
            ...
            .card-packetPull-wrap{
                width: px2rem(308px);
                height: px2rem(284px);
                @include img-retina("~@/assets/lottery-bindBox/record-packet.png",
                "~@/assets/lottery-bindBox/record-packet@2x.png", 100%, 100%);
                background-repeat: no-repeat;
                margin-left: auto;
                margin-right: auto;
