    ...
    <template v-if="essayTempAnswerInfo">
      ...
      <div class="from-wrap">
        ...
        <div class="upload-media-wrap">
          <div class="images-wrap" v-if="essayTempAnswerInfo.image && essayTempAnswerInfo.image.length">
          ...
          <!--音频播放-->
          <div class="eassy-audio-wrap" v-if="essayTempAnswerInfo.audio && essayTempAnswerInfo.audio.length">
          ...
          <!--视频播放-->
          <div class="eassy-video-wrap" v-if="essayTempAnswerInfo.video && essayTempAnswerInfo.video.length">
